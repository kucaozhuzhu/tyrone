...
<body>
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				<li>
					<span><aebiz:showTitle titleId="customer.menuOne"/></span>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<span><aebiz:showTitle titleId="customer.menuTwo"/></span>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
		...
		<div class="y_masuccess">
			...
			<div class="y_succms">
				...
				<p class="y_successtext">
					<a class="btn btn-primary" href="javascript:void(0);"><aebiz:showTitle titleId="basebusiness.showmessage.opeOk"/></a>  <a class="btn btn-danger" href="${pageContext.servletContext.contextPath}/sysback/customercomb/toList"><aebiz:showTitle titleId="basebusiness.showmessage.return"/></a>
				</p>	
			</div>
		</div>
	</div>
