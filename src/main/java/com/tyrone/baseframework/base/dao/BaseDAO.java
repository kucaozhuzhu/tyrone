...
public abstract interface BaseDAO<M extends BaseModel, QM extends M> {
    ...
    public abstract List<M> getByCondition(QM paramQM, int paramInt1,
            int paramInt2);

    public abstract List<String> getUuidsByCondition(QM paramQM, int paramInt1,
            int paramInt2);

    public abstract int getCount(QM paramQM);

    public abstract void setDataDeleteFlag(String paramString, int paramInt);
}
