...
<body>
	<div class="container-fluid">
		...
		<ul class="tabs tabs-inline tabs-top border1-top">
			<li class='active'><a href="#accountInfo" data-toggle='tab'><aebiz:showTitle titleId="customerInfo.m.customerAccountInfo"/></a></li>
			<li><a href="#baseInfo" data-toggle='tab'><aebiz:showTitle titleId="customerinfo.moduleName_CN"/></a></li>
		</ul>
			...
			<div class="tab-pane active" id="accountInfo">
				<div class="table table-bordered table-hover table-nomargin">
					<form:form id="accountInfoForm" action="${pageContext.servletContext.contextPath}/sysback/customercomb/updateAccountInfo" method="post" commandName="m" class='form-horizontal form-validate form-bordered'>
						...
						<div class="form-group">
							<label for="textfield" class="control-label col-sm-2  "><aebiz:showTitle titleId="customer.m.activeState"/></label>
							<div class="col-sm-10">
								<div class="col-sm-2">
									<div class="check-line">
										<form:radiobutton path="customerModel.activeState" id="c3" value="1" class="icheck-me" data-skin="square" data-color="blue"/>
										<label class='inline' for="c3"><aebiz:showTitle titleId="customer.m.actived" /></label>
									</div>
								</div>
								
								<div class="col-sm-2">
									<div class="check-line">
										<form:radiobutton path="customerModel.activeState" id="c4" value="0" class="icheck-me" data-skin="square" data-color="blue"/>
										<label class='inline' for="c4"><aebiz:showTitle titleId="customer.m.unactived" /></label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label for="textfield" class="control-label col-sm-2  "><aebiz:showTitle titleId="customer.m.frozenState"/></label>
							<div class="col-sm-10">
								<div class="col-sm-2">
									<div class="check-line">
										<form:radiobutton path="customerModel.frozenState" id="c1" value="1" class="icheck-me" data-skin="square" data-color="blue"/>
										<label class='inline' for="c1"><aebiz:showTitle titleId="customer.m.frozened" /></label>
									</div>
								</div>
								
								<div class="col-sm-2">
									<div class="check-line">
										<form:radiobutton path="customerModel.frozenState" id="c2" value="0" class="icheck-me" data-skin="square" data-color="blue"/>
										<label class='inline' for="c2"><aebiz:showTitle titleId="customer.m.unfrozened" /></label>
									</div>
								</div>
							</div>
						</div>
						
						<div class="form-group" id="frozenType">
							<label for="textfield" class="control-label col-sm-2 "><aebiz:showTitle titleId="customer.m.frozenType"/></label>
							<div class="col-sm-10">
								<div class="col-sm-3">
									<form:select path="customerModel.frozenType" class='select2-me form-control' data-rule-required="true">								
										<form:option value="">-<aebiz:showTitle titleId="basebusiness.showmessage.pleasechoose"/>-</form:option>
						...
						<div class="form-group" id="note">
							<label for="textfield" class="control-label col-sm-2 "><aebiz:showTitle titleId="customerfrozenlog.m.note"/></label>
							<div class="col-sm-10">
								<div class="col-sm-3">
									<form:textarea path="customerFrozenLogModel.note" class="form-control" rows="3" data-rule-maxlength="200"/>
								</div>	
							</div>
						</div>
