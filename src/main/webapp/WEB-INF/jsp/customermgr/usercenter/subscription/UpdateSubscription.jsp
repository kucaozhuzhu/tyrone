						...
						<div class="content">
							...
							<div class="main-content">
							    ...
							    <div class="widget serve-widget serve-detail">
									...
									<input type="hidden" id="customerUuid" value="${csm.customerUuid}"> 
								    ...
								    <div class="widget-content">
										   ...
										   <table class="table table-striped r_promotiontable">
										   	  <thead>
											      <tr>
											         <th><div class="control-inline simple-checkbox"><aebiz:showTitle titleId="ucenter_subscription_subName"/></div></th>	
										      ...
										      <tbody>
										      	 	<c:if test="${!empty cscm}">
										      	 		<input type="hidden" id="subUuid" value="${cscm.uuid}">
										      	 		<tr>
													    	<td>${cscm.subscribeName}</td>
													      	<td>${cscm.subscribeType}</td>
													      	<td>${cscm.description}</td>
													    </tr>
										      	 	</c:if>
										      </tbody>
										   </table>
				                      	...
				                      	<div class="row col-bothbB col-bothbT logi-num">
											...
											<div class="col-mi-10 col-sm-10 col-bothbL">
		                   						...
		                   						<input type="text" placeholder="<aebiz:showTitle titleId="ucenter_subscription_mobileSub"/>" id="mobile" value="${csm.mobile}" maxlength="11">
		                   						<aebiz:showTitle titleId="ucenter_subscription_or"/><br/>
												<i class="fa fa-envelope-o"></i>
												<input type="text" placeholder="<aebiz:showTitle titleId="ucenter_subscription_emailSub"/>" id="email" value="${csm.email}"><br/>
...
<script>
       	...
       	if(mobile==""){
       		if(email==""){
       			...
       			if(emailReg.test(email)){
       				doSub(customerUuid,mobile,email,subUuid);
       			}else{
    ...
    function doSub(customerUuid,mobile,email,subUuid){
    	var url="${pageContext.servletContext.contextPath}/usercenter/customersubscription/updateSubscription";
   		$.get(url,{"customerUuid":customerUuid,"mobile":mobile,"email":email,"subUuid":subUuid,"ranNum":Math.random()},function(data){
       		if(data=="true"){
