...
<body>
	...
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/><aebiz:showTitle titleId="syspermit.moduleName_CN"/></h1>
			</div>
		</div>
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					<span><aebiz:showTitle titleId="basebusiness.showmessage.newAdd"/><aebiz:showTitle titleId="syspermit.moduleName_CN"/></span>
				</li>
			</ul>
		</div>		
		...
		<div class="box box-bordered bordered-top">
			<div class="box-content nopadding">																
				<form id="mainForm" action="${pageContext.servletContext.contextPath}/sysback/syspermit/add" method="post" class='form-horizontal form-bordered form-validate'>						
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="expression" value="${m.expression}" class="form-control" data-rule-required="true" data-rule-minlength="2" data-rule-maxlength="50">
						</div>
					</div>
					
					<div class="form-group">
						<label for="textfield" class="control-label col-sm-2"><aebiz:showTitle titleId="syspermit.m.state"/></label>
						<div class="col-sm-10">
							<div class="check-line col-xs-4 col-sm-1">
								<input type="radio" name="state" id="sjshjs1" value="1" checked class='icheck-me' data-skin="square" data-color="blue"><label class="inline" for="sjshjs1"><aebiz:showTitle titleId="basebusiness.showmessage.on"/></label>
							</div>
							<div class="check-line col-xs-4 col-sm-1">
								<input type="radio" name="state" id="sjshjs2" value="0" class='icheck-me' data-skin="square" data-color="blue"><label class="inline" for="sjshjs2"><aebiz:showTitle titleId="basebusiness.showmessage.off"/></label>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="col-sm-2" >
								<select name="businessType" class='select2-me form-control'>		
										<c:forEach items="${permitTypes}" var="ptype">	
											<option value="${ptype.value}" <c:if test="${m.businessType==ptype.value}"> selected </c:if>>${ptype.name}</option>
										</c:forEach>	
								</select>													
							</div>
						</div>
