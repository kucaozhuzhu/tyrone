...
<body>
	<div class="container-fluid">
		<div class="page-header">
			<div class="pull-left">
				<h1><aebiz:showTitle titleId="platadimagerel.moduleName_CN"/><aebiz:showTitle titleId="basebusiness.showmessage.manager"/></h1>
			</div>
		</div>
		...
		<div class="y_masuccess">
			...
			<div class="y_succms">
				...
				<p class="y_successtext">
					<a class="btn btn-primary" href="javascript:void(0);"><aebiz:showTitle titleId="basebusiness.showmessage.opeOk"/></a>  <a class="btn btn-danger" href="${pageContext.servletContext.contextPath}/sysback/platad/toList"><aebiz:showTitle titleId="basebusiness.showmessage.return"/></a>
				</p>	
			</div>
		</div>
	</div>
