...
<head>
  <meta charset="utf-8">
  <title>前台非法请求</title>
  <meta name="description" content="前台非法请求">
  ...
  <!--[if lt IE 9]>
    ...
    <script src="${pageContext.servletContext.contextPath}/static/frontpage/js/html5shiv.js"></script>
  <![endif]-->
