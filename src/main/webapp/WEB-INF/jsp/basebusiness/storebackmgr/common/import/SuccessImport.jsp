<head>
	...
	<title>FLAT - Emails</title>

	<!-- Bootstrap -->
	<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/static/storeback/css/bootstrap.min.css">
	<!-- jQuery UI -->
	<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/static/storeback/css/plugins/jquery-ui/smoothness/jquery-ui.css">
	<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/static/storeback/css/plugins/jquery-ui/smoothness/jquery.ui.theme.css">
	<!-- Theme CSS -->
	...
	<!-- imagesLoaded -->
	<script src="${pageContext.servletContext.contextPath}/static/storeback/js/plugins/imagesLoaded/jquery.imagesloaded.min.js"></script>
	<!-- jQuery UI -->
	...
	<!-- slimScroll -->
	<script src="${pageContext.servletContext.contextPath}/static/storeback/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
	<!-- Bootstrap -->
	...
	<!-- Bootbox -->
	<script src="${pageContext.servletContext.contextPath}/static/storeback/js/plugins/form/jquery.form.min.js"></script>
	<!-- Validation -->
	<script src="${pageContext.servletContext.contextPath}/static/storeback/js/plugins/validation/jquery.validate.min.js"></script>
	<script src="${pageContext.servletContext.contextPath}/static/storeback/js/plugins/validation/additional-methods.min.js"></script>

	<!-- Theme framework -->
	<script src="${pageContext.servletContext.contextPath}/static/storeback/js/eakroko.min.js"></script>
	<!-- Theme scripts -->
	<script src="${pageContext.servletContext.contextPath}/static/storeback/js/application.min.js"></script>
	<!-- Just for demonstration -->
	<script src="${pageContext.servletContext.contextPath}/static/storeback/js/demonstration.min.js"></script>
