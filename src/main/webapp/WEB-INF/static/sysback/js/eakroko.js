...
$(document).ready(function() {
    ...
    // Calendar (fullcalendar) 可添加备注日历调用插件
    ...
    // masked input 调用input输入框的标记提示效果插件
