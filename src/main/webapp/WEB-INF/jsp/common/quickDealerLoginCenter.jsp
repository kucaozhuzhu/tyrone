				...
				<div class="y_suslgbx">
					...
					<c:if test="${hasVilidateCode == 'true'  }">
						<div class="form-group y_yzmgrop">
								...
								<div class="clearfix">
									<input type="text" placeholder="<aebiz:showTitle titleId='storeaccount.m.validateCode' />" required class="form-control" id="validateCode" name="validateCode" value="${validateCode }">
									<img id="validateImg" src="${pageContext.servletContext.contextPath}/getDealerLoginCode2" onClick="javascript:flushValidateCode();"/>
									<span><aebiz:showTitle titleId="storeaccount.m.vague" />？<a class="f_color2" href="javascript:flushValidateCode();"><aebiz:showTitle titleId="storeaccount.m.changerOther" /></a></span>
