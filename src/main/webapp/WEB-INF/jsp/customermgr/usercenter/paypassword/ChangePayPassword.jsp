					...
					<div class="col-xs-10 content-wrapper">
						...
						<div class="content">
							<div class="main-header">
								<h2><aebiz:showTitle titleId="ucenter.payPassword_modefyPayPassword"/></h2>
								...
								<form id="mainForm" class="form-horizontal y_setpassd form-validate" action="${pageContext.servletContext.contextPath}/usercenter/customer/setPayPassword" method="post">
									...
									<div class="form-group">
										...
										<p class="col-mi-7">
											...
											<a href="${pageContext.servletContext.contextPath}/usercenter/customer/toRetrievePayPassword/${m.uuid}">忘记密码？</a>
										</p>
...
<script>
	...
	  		 	password: {
					required : true,
					remote : {
						url: "${pageContext.request.contextPath }/usercenter/customer/checkPayPwd", 
						type:"get",
						dataType:"json",
						data:{
