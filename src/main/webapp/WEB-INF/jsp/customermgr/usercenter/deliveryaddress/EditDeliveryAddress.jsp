...
<div class="modal-dialog modal-760" id="editDiv">
	<div class="modal-content">
		<form id="editForm" action="${pageContext.servletContext.contextPath}/usercenter/customeraddress/doEdit"  class="form-horizontal y_setpassd form-validate" method="post">
			<input type="hidden" name="uuid" value="${m.uuid}">
			<input type="hidden" name="customerUuid" value="${m.customerUuid}">
			<input type="hidden" name="area">
			
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				<h3><aebiz:showTitle titleId="ucenter_deliveryAddress_edit"/></h3>
			</div>
			...
			<div class="modal-body">
				<div class="form-group">
					...
					<div class="col-mi-4">
						<input type="text" name="consignee" value="${m.consignee}" class="form-control"/>
					</div>
				</div>
				...
				<div class="form-group y_addresarea">
					...
					<div class="col-mi-10 ku_col">
						<aebiz:myarea checkProvince="${m.province}" checkCity="${m.city}"  checkRegion="${m.region}" checkStreet="${m.street}"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-mi-4">
						<input type="text" name="telephone" value="${m.telephone}" class="form-control telephone" maxlength="13" placeholder="区号-电话号码"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-mi-4">
						<input type="text" name="identityCard" class="form-control" value="${m.identityCard}">
				...
				<div class="form-group">
					...
					<div class="col-mi-4">
						<input type="text" name="zipcode" value="${m.zipcode}" class="form-control isZipCode"/>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-mi-offset-2 col-mi-10">
						<div class="simple-checkbox">
							<input type="checkbox" id="isDefault" name="isDefault" value="1" <c:if test="${m.isDefault==1}">checked</c:if>/>
