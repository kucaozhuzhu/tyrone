...
$(document).ready(function() {
    ...
    resizeContent();
		...
		//username-check input 输入框输入用户名的实时验证
    ...
    if ($('#vmap').length > 0) {
		...
		//模版首页Feeds模块自动刷新（Automatic refresh）按钮点击事件
